...
import br.com.ufra.rn.ProdutoRN;
...
public class ProdutoBean implements Serializable{
    ...
    private ProdutoRN rn = new ProdutoRN();

    public Produto getProcessamento() {
        return produto;
    }

    public void setProcessamento(Produto processamento) {
        this.produto = processamento;
    }
